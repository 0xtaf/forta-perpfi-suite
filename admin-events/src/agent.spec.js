    ...
    it("returns a finding if a target contract emits an event from its watchlist", async () => {
      ...
      const logsMatchEvent = [
        {
          ...
          topics: [
            ethers.utils.keccak256(
              ethers.utils.toUtf8Bytes("OwnershipTransferred(address,address)")
            ),
      ...
      const testFindings = [
        Finding.fromObject({
          ...
          description:
            "The OwnershipTransferred event was emitted by the InsuranceFund contract",
          ...
          metadata: {
            ...
            contractAddress: "0x1c9a192df3936cbf093d8afdc352718bcf834eb6",
